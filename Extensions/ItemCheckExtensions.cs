...
namespace WebmilioCommons.Extensions
{
    public static class ItemCheckExtensions
    {
        ...
        public static List<Item> GetItemsByType(this Player player, int type, bool inventory = false, bool armor = false, bool armorSocial = false, bool accessories = false, bool accessoriesSocial = false)
        {
            List<Item> filteredItems = new List<Item>();

            if (inventory)
                SearchItems(ref filteredItems, player.inventory, type);
            ...
            if (armor) // TODO Verify this works.
            {
                ...
                SearchItems(ref filteredItems, armorSlots, type);
            }
            ...
            if (accessories)
            {
                ...
                SearchItems(ref filteredItems, accessorySlots, type);
            }
        ...
        private static void SearchItems(ref List<Item> filtered, IEnumerable<Item> items, int type)
        {
            foreach (Item item in items)
